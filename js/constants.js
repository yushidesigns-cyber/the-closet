...
export const PAIRS = [['Tops','Bottoms'],['Tops','Footwear'],['Tops','Jewellery'],['Dresses','Footwear'],['Dresses','Jewellery'],
  ['Suits','Footwear'],['Suits','Jewellery'],['Sarees','Blouse'],['Sarees','Jewellery'],['Sarees','Footwear'],
  ['Lehenga','Jewellery'],['Lehenga','Footwear'],['Blouse','Jewellery']];
